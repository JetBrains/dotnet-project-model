...
import jetbrains.buildServer.dotnet.common.XmlDocumentServiceImpl
                ...
                Solution(
                    listOf(
                        Project(
                            ...
                            emptyList(),
                            emptyList(),
                            listOf(Runtime("win7-x64"), Runtime("win-7x86"), Runtime("ubuntu.16.10-x64")),
                            emptyList()
                        )
                    )
                )
            ...
            arrayOf(
                ...
                Solution(
                    listOf(
                        Project(
                            "projectPath",
                            listOf(Configuration("Debug"), Configuration("Release")),
                            emptyList(),
                            emptyList(),
                            listOf(
                ...
                Solution(
                    listOf(
                        Project(
                            ...
                            emptyList(),
                            listOf(Reference("Microsoft.NET.Sdk"), Reference("Microsoft.NET.Test.Sdk"))
                        )
                    )
                )
            ),
                ...
                Solution(
                    listOf(
                        Project(
                            ...
                            emptyList(),
                            emptyList(),
                            listOf(Target("GetNuGet"), Target("Build"), Target("Test"))
                        )
                    )
                )
            ),
                ...
                Solution(
                    listOf(
                        Project(
                            "projectPath",
                            emptyList(),
                            listOf(Framework("net45"), Framework("netstandard1.3")),
                            emptyList(),
